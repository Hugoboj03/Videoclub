...
<p><a href='insertar_pelicula.php'>Añadir Película</a></p>
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($tipo_usuario == "Empleado") { ?>
                            <form action="editar_pelicula.php" method="post" style="display:inline;">
                                <input type="hidden" name="id_pelicula" value="<?php echo $resultado['id']; ?>">
